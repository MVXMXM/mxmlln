...
A designer must be intricately familiar with their materials. In the past this meant understanding the nuanced properties of woods, metals, printing presses, & eventually pixels. Today's digital designers must work with a much more intangible material: an algorithm.
